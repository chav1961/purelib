...
public class JFreezableTable extends JTable {
	...
	public static void main(final String[] args) {
		...
		final JFreezableTable tnew = new JFreezableTable(t.getModel(), "c1", "c2");
	...
	public JFreezableTable(final TableModel model, final String... columns2freeze) {
		super(model);
