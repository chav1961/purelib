...
class RLMatrixImpl implements Matrix {
	private final int		rows;
	private final int		cols;
	private final long[]	content;

	RLMatrixImpl(final int rows, final int cols) {
		this.rows = rows;
		this.cols = cols;
		this.content = new long[rows * cols];
	}
	...
	public int[] extractInts() {
		throw new UnsupportedOperationException("Can't extract ints because matrix content is long"); 
	}
	...
	public float[] extractFloats() {
		throw new UnsupportedOperationException("Can't extract floats because matrix content is int"); 
	}
	...
	public double[] extractDoubles() {
		throw new UnsupportedOperationException("Can't extract doubles because matrix content is int"); 
	}
	...
	public Matrix assign(final int... content) {
		throw new UnsupportedOperationException("Can't assign ints because matrix content is long"); 
	}
	...
	public Matrix assign(final float... content) {
		throw new UnsupportedOperationException("Can't assign floats because matrix content is int"); 
	}
	...
	public Matrix assign(final double... content) {
		throw new UnsupportedOperationException("Can't assign doubles because matrix content is int"); 
	}
	...
	public Matrix assign(final Matrix content) {
		if (content == null) {
			...
			System.arraycopy(content.extractLongs(), 0, this.content, 0, this.content.length);
			return this;
		}
	}
	...
	public Matrix fill(final int value) {
		throw new UnsupportedOperationException("Can't fill ints because matrix content is long"); 
	}
	...
	public Matrix fill(final float value) {
		throw new UnsupportedOperationException("Can't fill floats because matrix content is long"); 
	}
	...
	public Matrix fill(final double value) {
		throw new UnsupportedOperationException("Can't fill doubles because matrix content is long"); 
	}
	...
	public Matrix add(final int... content) {
		throw new UnsupportedOperationException("Can't add ints because matrix content is long"); 
	}
	...
	public Matrix add(final float... content) {
		throw new UnsupportedOperationException("Can't add floats because matrix content is long"); 
	}

	@Override
	public Matrix add(final double... content) {
		throw new UnsupportedOperationException("Can't add doubles because matrix content is long"); 
	}
	...
	public Matrix subtract(final int... content) {
		throw new UnsupportedOperationException("Can't subtract ints because matrix content is long"); 
	}
	...
	public Matrix subtract(final float... content) {
		throw new UnsupportedOperationException("Can't subtract floats because matrix content is long"); 
	}

	@Override
	public Matrix subtract(final double... content) {
		throw new UnsupportedOperationException("Can't subtract doubles because matrix content is long"); 
	}
	...
	public Matrix mul(Matrix content) {
		throw new UnsupportedOperationException("Can't add longs because matrix content is long"); 
	}
	...
	public Matrix mulValue(final int value) {
		throw new UnsupportedOperationException("Can't multiply ints because matrix content is long"); 
	}
	...
	public Matrix mulValue(final float value) {
		throw new UnsupportedOperationException("Can't multiply floats because matrix content is long"); 
	}
	...
	public Matrix mulValue(final double value) {
		throw new UnsupportedOperationException("Can't multiply doubles because matrix content is long"); 
	}
	...
	public Matrix divValue(final int value) {
		throw new UnsupportedOperationException("Can't divide ints because matrix content is long"); 
	}
	...
	public Matrix divValue(final float value) {
		throw new UnsupportedOperationException("Can't divide floats because matrix content is long"); 
	}
	...
	public Matrix divValue(final double value) {
		throw new UnsupportedOperationException("Can't divide doubles because matrix content is long"); 
	}
	...
	public Matrix mulInvHadamard(final int... content) {
		throw new UnsupportedOperationException("Can't multiply longs because matrix content is long"); 
	}
	...
	public Matrix tensorMul(final Matrix content) {
		...
		if (content == null) {
			...
			final Matrix	result = new RLMatrixImpl(rowSize, colSize);
			final long[]	left = this.content, right = content.extractLongs(), target = result.extractLongs();
			
			for(int xLeft = 0, maxXLeft = numberOfRows(); xLeft < maxXLeft; xLeft++) {
				for(int yLeft = 0, maxYLeft = numberOfColumns(); yLeft < maxYLeft; yLeft++) {
					final long	multiplier = left[xLeft * numberOfColumns() + yLeft];
	...
	public Matrix invert() {
		if (numberOfRows() != numberOfColumns()) {
			...
			return cast(Type.REAL_DOUBLE).invert();
		}
	}
		...
		if (dir == null) {
			...
			switch (dir) {
				case ByColumns	:
					...
					amount = numberOfRows();
					result = new RLMatrixImpl(1, numberOfColumns());
					break;
				case ByRows		:
					loops = numberOfRows();
					step = 1;
					...
					result = new RLMatrixImpl(numberOfRows(), 1);
					break;
				default:
	...
	public String toHumanReadableString() {
		...
		for(int x = 0, maxX = numberOfRows(); x < maxX; x++) {
			...
			for(int y = 0, maxY = numberOfColumns(); y < maxY; y++) {
				sb.append(String.format("%1$20d ", this.content[x * maxY + y]));
			}
			sb.append('\n');
		}
		return sb.toString();
