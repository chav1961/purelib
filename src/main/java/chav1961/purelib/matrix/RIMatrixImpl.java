...
class RIMatrixImpl implements Matrix {
	private final int	rows;
	private final int	cols;
	private final int[]	content;

	RIMatrixImpl(final int rows, final int cols) {
		this.rows = rows;
		this.cols = cols;
	...
	public long[] extractLongs() {
		throw new UnsupportedOperationException("Can't extract longs because matrix content is int"); 
	}
	...
	public Matrix assign(final long... content) {
		throw new UnsupportedOperationException("Can't assign longs because matrix content is int"); 
	}
	...
	public Matrix assign(final Matrix content) {
		if (content == null) {
			...
			System.arraycopy(content.extractInts(), 0, this.content, 0, this.content.length);
			return this;
		}
	}
	...
	public Matrix fill(final long value) {
		throw new UnsupportedOperationException("Can't fill longs because matrix content is int"); 
	}
	...
	public Matrix fill(final float value) {
		throw new UnsupportedOperationException("Can't fill floats because matrix content is int"); 
	}
	...
	public Matrix fill(final double value) {
		throw new UnsupportedOperationException("Can't fill doubles because matrix content is int"); 
	}
	...
	public Matrix add(final long... content) {
		throw new UnsupportedOperationException("Can't add longs because matrix content is int"); 
	}

	@Override
	public Matrix add(final float... content) {
		throw new UnsupportedOperationException("Can't add floats because matrix content is int"); 
	}

	@Override
	public Matrix add(final double... content) {
		throw new UnsupportedOperationException("Can't add doubles because matrix content is int"); 
	}
	...
	public Matrix addValue(final long value) {
		throw new UnsupportedOperationException("Can't add long because matrix content is int"); 
	}
	...
	public Matrix subtract(final long... content) {
		throw new UnsupportedOperationException("Can't subtract longs because matrix content is int"); 
	}

	@Override
	public Matrix subtract(final float... content) {
		throw new UnsupportedOperationException("Can't subtract floats because matrix content is int"); 
	}

	@Override
	public Matrix subtract(final double... content) {
		throw new UnsupportedOperationException("Can't subtract doubles because matrix content is int"); 
	}
	...
	public Matrix mulValue(final long value) {
		throw new UnsupportedOperationException("Can't multiply longs because matrix content is int"); 
	}

	@Override
	public Matrix mulValue(final float value) {
		throw new UnsupportedOperationException("Can't multiply floats because matrix content is int"); 
	}
	...
	public Matrix mulValue(final double value) {
		throw new UnsupportedOperationException("Can't multiply doubles because matrix content is int"); 
	}
	...
	public Matrix divValue(final long value) {
		throw new UnsupportedOperationException("Can't divide longs because matrix content is int"); 
	}

	@Override
	public Matrix divValue(final float value) {
		throw new UnsupportedOperationException("Can't divide floats because matrix content is int"); 
	}
	...
	public Matrix divValue(final double value) {
		throw new UnsupportedOperationException("Can't divide doubles because matrix content is int"); 
	}
	...
	public Matrix tensorMul(final Matrix content) {
		...
		if (content == null) {
			...
			final int[]		left = this.content, right = content.extractInts(), target = result.extractInts();
			
			for(int xLeft = 0, maxXLeft = numberOfRows(); xLeft < maxXLeft; xLeft++) {
				for(int yLeft = 0, maxYLeft = numberOfColumns(); yLeft < maxYLeft; yLeft++) {
					final int	multiplier = left[xLeft * numberOfColumns() + yLeft];
	...
	public String toHumanReadableString() {
		...
		for(int x = 0, maxX = numberOfRows(); x < maxX; x++) {
			...
			for(int y = 0, maxY = numberOfColumns(); y < maxY; y++) {
				sb.append(String.format("%1$11d ", this.content[x * maxY + y]));
			}
			sb.append('\n');
		}
		return sb.toString();
