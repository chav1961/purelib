...
public class FloatMatrixImpl implements FloatMatrix {
	...
	public Matrix mul(final Matrix another) {
		if (another == null) {
			...
			final float[]	sum = new float[sizeY * anotherX];
			...
			return new FloatMatrixImpl(sizeY, anotherX, false, sum);
		}
	}
	...
	public Matrix transp() {
		if (sizeX == 1 || sizeY == 1) {
			return new FloatMatrixImpl(sizeY, sizeX, content);
		}
		else {
			...
			return new FloatMatrixImpl(sizeY, sizeX, false, result);
		}
	}
