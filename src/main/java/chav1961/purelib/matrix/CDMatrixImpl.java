...
class CDMatrixImpl implements Matrix {
	private final int		rows;
	private final int		cols;
	private final double[]	content;

	CDMatrixImpl(final int rows, final int cols) {
		this.rows = rows;
		this.cols = cols;
		this.content = new double[2 * rows * cols];
	}
	...
	public int[] extractInts() {
		throw new UnsupportedOperationException("Can't extract ints because matrix content is complex double"); 
	}
	...
	public long[] extractLongs() {
		throw new UnsupportedOperationException("Can't extract longs because matrix content is complex double"); 
	}
	...
	public float[] extractFloats() {
		throw new UnsupportedOperationException("Can't extract floats because matrix content is complex double"); 
	}
	...
	public Matrix assign(final int... content) {
		throw new UnsupportedOperationException("Can't assign ints because matrix content is complex double"); 
	}
	...
	public Matrix assign(final long... content) {
		throw new UnsupportedOperationException("Can't assign longs because matrix content is complex double"); 
	}
	...
	public Matrix assign(final float... content) {
		throw new UnsupportedOperationException("Can't assign floats because matrix content is complex double"); 
	}
	...
	public Matrix fill(final int value) {
		throw new UnsupportedOperationException("Can't fill ints because matrix content is complex double"); 
	}
	...
	public Matrix fill(final long value) {
		throw new UnsupportedOperationException("Can't fill longs because matrix content is complex double"); 
	}
	...
	public Matrix fill(final float value) {
		throw new UnsupportedOperationException("Can't fill floats because matrix content is complex double"); 
	}
	...
	public Matrix fill(final double value) {
		throw new UnsupportedOperationException("Can't fill doubles because matrix content is complex double"); 
	}
	...
	public Matrix fill(final double real, final double image) {
		final double[]	temp = this.content;
	...
	public Matrix add(final int... content) {
		throw new UnsupportedOperationException("Can't add ints because matrix content is complex double"); 
	}

	@Override
	public Matrix add(final long... content) {
		throw new UnsupportedOperationException("Can't add longs because matrix content is complex double"); 
	}

	@Override
	public Matrix add(final float... content) {
		throw new UnsupportedOperationException("Can't add floats because matrix content is complex double"); 
	}
	...
	public Matrix addValue(final long value) {
		throw new UnsupportedOperationException("Can't add long because matrix content is complex double"); 
	}
	...
	public Matrix subtract(final int... content) {
		throw new UnsupportedOperationException("Can't subtract ints because matrix content is complex double"); 
	}

	@Override
	public Matrix subtract(final long... content) {
		throw new UnsupportedOperationException("Can't subtract longs because matrix content is complex double"); 
	}

	@Override
	public Matrix subtract(final float... content) {
		throw new UnsupportedOperationException("Can't subtract floats because matrix content is complex double"); 
	}
	...
	public Matrix mulValue(final int value) {
		throw new UnsupportedOperationException("Can't multiply ints because matrix content is complex double"); 
	}

	@Override
	public Matrix mulValue(final long value) {
		throw new UnsupportedOperationException("Can't multiply longs because matrix content is complex double"); 
	}

	@Override
	public Matrix mulValue(final float value) {
		throw new UnsupportedOperationException("Can't multiply floats because matrix content is complex double"); 
	}
	...
	public Matrix divValue(final int value) {
		throw new UnsupportedOperationException("Can't divide ints because matrix content is complex double"); 
	}

	@Override
	public Matrix divValue(final long value) {
		throw new UnsupportedOperationException("Can't divide longs because matrix content is complex double"); 
	}

	@Override
	public Matrix divValue(final float value) {
		throw new UnsupportedOperationException("Can't divide floats because matrix content is complex double"); 
	}
	...
	public Matrix tensorMul(final Matrix content) {
		...
		if (content == null) {
			...
			final Matrix	result = new CDMatrixImpl(rowSize, colSize);
		...
		if (dir == null) {
			...
			switch (dir) {
				case ByColumns	:
					...
					amount = numberOfRows();
					result = new CDMatrixImpl(1, numberOfColumns());
					break;
				case ByRows		:
					loops = numberOfRows();
					step = 1;
					...
					result = new CDMatrixImpl(numberOfRows(), 1);
					break;
				default:
	...
	public String toHumanReadableString() {
		...
		for(int x = 0, maxX = numberOfRows(); x < maxX; x++) {
			...
			for(int y = 0, maxY = numberOfColumns(); y < maxY; y++) {
				sb.append(String.format("%1$25g+%1$25gi", this.content[2 * (x * maxY + y)], this.content[2 * (x * maxY + y) + 1]));
			}
			sb.append('\n');
		}
		return sb.toString();
