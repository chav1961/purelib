...
class RFMatrixImpl implements Matrix {
	private final int		rows;
	private final int		cols;
	private final float[]	content;

	RFMatrixImpl(final int rows, final int cols) {
		this.rows = rows;
		this.cols = cols;
	...
	public int[] extractInts() {
		throw new UnsupportedOperationException("Can't extract ints because matrix content is float"); 
	}
	...
	public long[] extractLongs() {
		throw new UnsupportedOperationException("Can't extract longs because matrix content is float"); 
	}
	...
	public double[] extractDoubles() {
		throw new UnsupportedOperationException("Can't extract doubles because matrix content is float"); 
	}
	...
	public Matrix assign(final int... content) {
		throw new UnsupportedOperationException("Can't assign ints because matrix content is float"); 
	}
	...
	public Matrix assign(final long... content) {
		throw new UnsupportedOperationException("Can't assign longs because matrix content is float"); 
	}
	...
	public Matrix assign(final double... content) {
		throw new UnsupportedOperationException("Can't assign doubles because matrix content is float"); 
	}
	...
	public Matrix fill(final int value) {
		throw new UnsupportedOperationException("Can't fill ints because matrix content is float"); 
	}
	...
	public Matrix fill(final long value) {
		throw new UnsupportedOperationException("Can't fill longs because matrix content is float"); 
	}
	...
	public Matrix fill(final float real, final float image) {
		throw new UnsupportedOperationException("Can't fill floats because matrix content is float"); 
	}
	...
	public Matrix fill(final double value) {
		throw new UnsupportedOperationException("Can't fill doubles because matrix content is float"); 
	}
	...
	public Matrix add(final int... content) {
		throw new UnsupportedOperationException("Can't add ints because matrix content is float"); 
	}

	@Override
	public Matrix add(final long... content) {
		throw new UnsupportedOperationException("Can't add longs because matrix content is float"); 
	}
	...
	public Matrix add(final double... content) {
		throw new UnsupportedOperationException("Can't add doubles because matrix content is float"); 
	}
	...
	public Matrix addValue(final long value) {
		throw new UnsupportedOperationException("Can't add long because matrix content is float"); 
	}
	...
	public Matrix addValue(final float real, final float image) {
		throw new UnsupportedOperationException("Can't add floats because matrix content is float"); 
	}
	...
	public Matrix subtract(final int... content) {
		throw new UnsupportedOperationException("Can't subtract ints because matrix content is float"); 
	}

	@Override
	public Matrix subtract(final long... content) {
		throw new UnsupportedOperationException("Can't subtract longs because matrix content is float"); 
	}
	...
	public Matrix subtract(final double... content) {
		throw new UnsupportedOperationException("Can't subtract doubles because matrix content is float"); 
	}
	...
	public Matrix subtractValue(final float real, final float image) {
		throw new UnsupportedOperationException("Can't subtract floats because matrix content is float"); 
	}
	...
	public Matrix mulValue(final int value) {
		throw new UnsupportedOperationException("Can't multiply ints because matrix content is float"); 
	}

	@Override
	public Matrix mulValue(final long value) {
		throw new UnsupportedOperationException("Can't multiply longs because matrix content is float"); 
	}
	...
	public Matrix mulValue(final float real, final float image) {
		throw new UnsupportedOperationException("Can't multiply floats because matrix content is float"); 
	}

	@Override
	public Matrix mulValue(final double value) {
		throw new UnsupportedOperationException("Can't multiply doubles because matrix content is float"); 
	}
	...
	public Matrix divValue(final int value) {
		throw new UnsupportedOperationException("Can't divide ints because matrix content is float"); 
	}

	@Override
	public Matrix divValue(final long value) {
		throw new UnsupportedOperationException("Can't divide longs because matrix content is float"); 
	}
	...
	public Matrix divValue(final float real, final float image) {
		throw new UnsupportedOperationException("Can't divide floats because matrix content is float"); 
	}

	@Override
	public Matrix divValue(final double value) {
		throw new UnsupportedOperationException("Can't divide doubles because matrix content is float"); 
	}
	...
	public Matrix tensorMul(final Matrix content) {
		...
		if (content == null) {
			...
			final Matrix	result = new RFMatrixImpl(rowSize, colSize);
		...
		if (dir == null) {
			...
			switch (dir) {
				case ByColumns	:
					...
					amount = numberOfRows();
					result = new RFMatrixImpl(1, numberOfColumns());
					break;
				case ByRows		:
					loops = numberOfRows();
					step = 1;
					...
					result = new RFMatrixImpl(numberOfRows(), 1);
					break;
				default:
	...
	public String toHumanReadableString() {
		...
		for(int x = 0, maxX = numberOfRows(); x < maxX; x++) {
			...
			for(int y = 0, maxY = numberOfColumns(); y < maxY; y++) {
				sb.append(String.format("%1$15g ", this.content[x * maxY + y]));
			}
			sb.append('\n');
		}
		return sb.toString();
