...
public class SimpleAssetResolver extends SVGExternalFileResolver
{
   ...
   {
      System.err.println("resolveFont("+fontFamily+","+fontWeight+","+fontStyle+")");

      // Try font name with suffix ".ttf"
      try
      {
         return Typeface.createFromAsset(fontFamily + ".ttf");
      }
      ...
      try
      {
         return Typeface.createFromAsset(fontFamily + ".otf");
      }
   ...
   {
      System.err.println("resolveImage("+filename+")");

//      try
//      {
         InputStream  istream = SimpleAssetResolver.class.getResourceAsStream(filename);
...
//      }
   ...
   {
      System.err.println("resolveCSSStyleSheet("+url+")");
   ...
   private String getAssetAsString(String url)
   {
      ...
      try
      {
         is = SimpleAssetResolver.class.getResourceAsStream(url);
