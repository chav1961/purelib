...
public class SVG {
    ...
    */
   public static SVG build(InputStream is) throws SVGParseException {
    ...
    * @throws SVGParseException if there is an error parsing the document.
    */
   public static SVG build(String svg) throws SVGParseException {
      SVGParser  parser = new SVGParser();
   ...
   public Set<String> getViewList()
   {
      ...
      for (SvgObject elem: viewElems)
      {
         ...
         if (view.id != null)
            ...
            System.err.println("AndroidSVG"+"getViewList(): found a <view> without an id attribute");
      }
      return viewIds;
   }
