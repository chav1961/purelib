...
import chav1961.purelib.matrix.interfaces.Matrix.ApplyLong;
...
public class LongRealMatrixTest {
	...
	public void basicTest() throws RuntimeException, CloneNotSupportedException, IOException {
		...
		try(final LongRealMatrix	m = new LongRealMatrix(2, 3)) {
			...
			Assert.assertArrayEquals(new long[] {1,2,3,4,10,20}, m.extractLongs());
			...
			Assert.assertArrayEquals(new long[] {6,5,4,3,2,1}, m.extractLongs());
			...
			Assert.assertArrayEquals(new long[] {6,5,4,3,10,20}, m.extractLongs());
			...
			Assert.assertArrayEquals(new long[] {1,3,5,7,9,11}, m.extractLongs());
			...
			Assert.assertArrayEquals(new long[] {1,3,5,7,10,20}, m.extractLongs());
			...
			Assert.assertArrayEquals(new long[] {11,9,7,5,3,1}, m.extractLongs());
			...
			Assert.assertArrayEquals(new long[] {11,9,7,5,10,20}, m.extractLongs());
			...
			try(final LongRealMatrix	dcm = (LongRealMatrix)m.clone()) {
			...
			m.assign(1,2,3,4,5,6);
			m.fill(10);
			Assert.assertArrayEquals(new long[] {10,10,10,10,10,10}, m.extractLongs());
			m.fill(20L);
			Assert.assertArrayEquals(new long[] {20,20,20,20,20,20}, m.extractLongs());
			m.fill(30f);
			Assert.assertArrayEquals(new long[] {30,30,30,30,30,30}, m.extractLongs());
			m.fill(40d);
			Assert.assertArrayEquals(new long[] {40,40,40,40,40,40}, m.extractLongs());
...
//			}
			...
			m.apply((int x, int y, long val)->0L);
			Assert.assertArrayEquals(new long[] {0,0,0,0,0,0}, m.extractLongs());
			try {m.apply((ApplyLong)null);
				Assert.fail("Mandatory exception was not detected (null 1-st argument)");
			} catch (NullPointerException exc) {
			}
		}
	...
	public void mulValueTest() {
		try(final LongRealMatrix	m = new LongRealMatrix(2, 3)) {
			m.assign(10,20,30,40,50,60);
			
			// int muls
			
			Assert.assertArrayEquals(new long[] {100,200,300,400,500,600}, m.mulValue(10).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,2,3,4,5,6}, m.divValue(10).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {20,10,6,5,4,3}, m.divFromValue(200).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {100,200,300,400,500,600}, m.mulValue(10L).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,2,3,4,5,6}, m.divValue(10L).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {20,10,6,5,4,3}, m.divFromValue(200L).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {100,200,300,400,500,600}, m.mulValue(10f).done().extractLongs());
			try {
				m.mulValue(5f, 5f);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new long[] {1,2,3,4,5,6}, m.divValue(10f).done().extractLongs());
			try {
				m.divValue(2f, 2f);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new long[] {20,10,6,5,4,3}, m.divFromValue(200f).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {100,200,300,400,500,600}, m.mulValue(10d).done().extractLongs());
			try {
				m.mulValue(5d, 5d);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new long[] {1,2,3,4,5,6}, m.divValue(10d).done().extractLongs());
			try {
				m.divValue(2d, 2d);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new long[] {20,10,6,5,4,3}, m.divFromValue(200d).done().extractLongs());
			try {
				m.divFromValue(2d, 2d);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
	...
	public void mulHadamardTest() {
		try(final LongRealMatrix	m1 = new LongRealMatrix(2, 3);
			...
			Assert.assertArrayEquals(new long[] {1,4,9,16,25,36}, m1.mulHadamard(1,2,3,4,5,6).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,1,1,1,1,1}, m1.mulInvHadamard(1,2,3,4,5,6).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,1,1,1,1,1}, m1.mulInvFromHadamard(1,2,3,4,5,6).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,4,9,16,25,36}, m1.mulHadamard(1L,2L,3L,4L,5L,6L).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,1,1,1,1,1}, m1.mulInvHadamard(1L,2L,3L,4L,5L,6L).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {10L,10L,10L,10L,10L,10L}, m1.mulInvFromHadamard(10L,20L,30L,40L,50L,60L).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,4,9,16,25,36}, m1.mulHadamard(1f,2f,3f,4f,5f,6f).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,1,1,1,1,1}, m1.mulInvHadamard(1f,2f,3f,4f,5f,6f).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {10,10,10,10,10,10}, m1.mulInvFromHadamard(10f,20f,30f,40f,50f,60f).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,4,9,16,25,36}, m1.mulHadamard(1d,2d,3d,4d,5d,6d).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,1,1,1,1,1}, m1.mulInvHadamard(1d,2d,3d,4d,5d,6d).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {10,10,10,10,10,10}, m1.mulInvFromHadamard(10d,20d,30d,40d,50d,60d).done().extractLongs());
			try {
			...
			m2.assign(1,2,3,4,5,6);
			Assert.assertArrayEquals(new long[] {1,4,9,16,25,36}, m1.mulHadamard(m2).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {1,1,1,1,1,1}, m1.mulInvHadamard(m2).done().extractLongs());
			try {
			...
			Assert.assertArrayEquals(new long[] {10,10,10,10,10,10}, m1.mulInvFromHadamard(m2).done().extractLongs());
	 		try {
	...
	public void unaryTest() {
		try(final LongRealMatrix	m = new LongRealMatrix(3, 3)) {
			...
			Assert.assertEquals(16L, m.track());
			try {
				m.track2();
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
	...
	public void aggregateTest() {
		try(final LongRealMatrix	m = new LongRealMatrix(3, 3)) {
			...
			Assert.assertArrayEquals(new long[] {6, 15, 24}, m.aggregate(AggregateDirection.ByColumns, AggregateType.Sum).done().extractLongs());
			Assert.assertArrayEquals(new long[] {12, 15, 18}, m.aggregate(AggregateDirection.ByRows, AggregateType.Sum).done().extractLongs());
			Assert.assertArrayEquals(new long[] {45}, m.aggregate(AggregateDirection.Total, AggregateType.Sum).done().extractLongs());

			Assert.assertArrayEquals(new long[] {1, 4, 7}, m.aggregate(AggregateDirection.ByColumns, AggregateType.Min).done().extractLongs());
			Assert.assertArrayEquals(new long[] {1, 2, 3}, m.aggregate(AggregateDirection.ByRows, AggregateType.Min).done().extractLongs());
			Assert.assertArrayEquals(new long[] {1}, m.aggregate(AggregateDirection.Total, AggregateType.Min).done().extractLongs());

			Assert.assertArrayEquals(new long[] {3, 6, 9}, m.aggregate(AggregateDirection.ByColumns, AggregateType.Max).done().extractLongs());
			Assert.assertArrayEquals(new long[] {7, 8, 9}, m.aggregate(AggregateDirection.ByRows, AggregateType.Max).done().extractLongs());
			Assert.assertArrayEquals(new long[] {9}, m.aggregate(AggregateDirection.Total, AggregateType.Max).done().extractLongs());

			try{m.aggregate(AggregateDirection.Total, AggregateType.Avg);
				Assert.fail("Mandatory exception was not detected (null 1-st argument)");
			} catch (UnsupportedOperationException exc) {
			}
			...
			try{m.aggregate(AggregateDirection.ByColumns, AggregateType.Sum).extractLongs();
				Assert.fail("Mandatory exception was not detected (done() call is missing)");
			} catch (IllegalStateException exc) {
			}
		}
