...
import chav1961.purelib.matrix.interfaces.Matrix.ApplyInt;
...
public class IntRealMatrixTest {
	...
	public void basicTest() throws RuntimeException, CloneNotSupportedException, IOException {
		...
		try(final IntRealMatrix	m = new IntRealMatrix(2, 3)) {
			...
			Assert.assertArrayEquals(new int[] {1,2,3,4,10,20}, m.extractInts());
			...
			Assert.assertArrayEquals(new int[] {6,5,4,3,2,1}, m.extractInts());
			...
			Assert.assertArrayEquals(new int[] {6,5,4,3,10,20}, m.extractInts());
			...
			Assert.assertArrayEquals(new int[] {1,3,5,7,9,11}, m.extractInts());
			...
			Assert.assertArrayEquals(new int[] {1,3,5,7,10,20}, m.extractInts());
			...
			Assert.assertArrayEquals(new int[] {11,9,7,5,3,1}, m.extractInts());
			...
			Assert.assertArrayEquals(new int[] {11,9,7,5,10,20}, m.extractInts());
			...
			try(final IntRealMatrix	dcm = (IntRealMatrix)m.clone()) {
			...
			m.assign(1,2,3,4,5,6);
			m.fill(10);
			Assert.assertArrayEquals(new int[] {10,10,10,10,10,10}, m.extractInts());
			m.fill(20L);
			Assert.assertArrayEquals(new int[] {20,20,20,20,20,20}, m.extractInts());
			m.fill(30f);
			Assert.assertArrayEquals(new int[] {30,30,30,30,30,30}, m.extractInts());
			m.fill(40d);
			Assert.assertArrayEquals(new int[] {40,40,40,40,40,40}, m.extractInts());
...
//			}
			...
			m.apply((int x, int y, int val)->0);
			Assert.assertArrayEquals(new int[] {0,0,0,0,0,0}, m.extractInts());
			try {m.apply((ApplyInt)null);
				Assert.fail("Mandatory exception was not detected (null 1-st argument)");
			} catch (NullPointerException exc) {
			}
		}
	...
	public void mulValueTest() {
		try(final IntRealMatrix	m = new IntRealMatrix(2, 3)) {
			...
			Assert.assertArrayEquals(new int[] {100,200,300,400,500,600}, m.mulValue(10).done().extractInts());
			try {
			...
			Assert.assertArrayEquals(new int[] {1,2,3,4,5,6}, m.divValue(10).done().extractInts());
			try {
			...
			Assert.assertArrayEquals(new int[] {20,10,6,5,4,3}, m.divFromValue(200).done().extractInts());
			try {
			...
			Assert.assertArrayEquals(new int[] {100,200,300,400,500,600}, m.mulValue(10L).done().extractInts());
			try {
			...
			Assert.assertArrayEquals(new int[] {1,2,3,4,5,6}, m.divValue(10L).done().extractInts());
			try {
			...
			Assert.assertArrayEquals(new int[] {20,10,6,5,4,3}, m.divFromValue(200L).done().extractInts());
			try {
			...
			Assert.assertArrayEquals(new int[] {100,200,300,400,500,600}, m.mulValue(10f).done().extractInts());
			try {
				m.mulValue(5f, 5f);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new int[] {1,2,3,4,5,6}, m.divValue(10f).done().extractInts());
			try {
				m.divValue(2f, 2f);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new int[] {20,10,6,5,4,3}, m.divFromValue(200f).done().extractInts());
			try {
			...
			Assert.assertArrayEquals(new int[] {100,200,300,400,500,600}, m.mulValue(10d).done().extractInts());
			try {
				m.mulValue(5d, 5d);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new int[] {1,2,3,4,5,6}, m.divValue(10d).done().extractInts());
			try {
				m.divValue(2d, 2d);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
			...
			Assert.assertArrayEquals(new int[] {20,10,6,5,4,3}, m.divFromValue(200d).done().extractInts());
			try {
				m.divFromValue(2d, 2d);
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
	...
	public void unaryTest() {
		try(final IntRealMatrix	m = new IntRealMatrix(3, 3)) {
			...
			Assert.assertEquals(16, m.track());
			try {
				m.track2();
				Assert.fail("Mandatory exception was not detected (unsupported operation)");
			} catch (UnsupportedOperationException exc) {
