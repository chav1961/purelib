...
public class GettersAndSettersFactoryTest {
	...
	public void uriStyledTest() throws IllegalArgumentException, NullPointerException, ContentException {
		...
		try{GettersAndSettersFactory.buildGetterAndSetter(URI.create(ContentMetadataInterface.APPLICATION_SCHEME+":"+Constants.MODEL_APPLICATION_SCHEME_FIELD+":/"));
			Assert.fail("Mandatory exception was not detected (illegal path format)");
		} catch (IllegalArgumentException exc) {			
		}
		try{GettersAndSettersFactory.buildGetterAndSetter(URI.create(ContentMetadataInterface.APPLICATION_SCHEME+":"+Constants.MODEL_APPLICATION_SCHEME_FIELD+":/unknown/unknown"));
	...
	public void primitivePrivateTest() throws IllegalArgumentException, NullPointerException, ContentException, NoSuchMethodException, SecurityException, IllegalAccessException, InvocationTargetException {
		final Method	m = GettersAndSettersFactory.class.getDeclaredMethod("prepareStatic");
	...
	@Test
	public void serializerTest() throws IllegalArgumentException, NullPointerException, ContentException, NoSuchMethodException, SecurityException, IllegalAccessException, InvocationTargetException, InstantiationException {
		final Serializer<PseudoSerializable>	pss = GettersAndSettersFactory.buildSerializer(PseudoSerializable.class, (list)->{}, PureLibSettings.INTERNAL_LOADER);
	}
}
