...
public class SwingUnitTestTest {
	...
	@Test
	public void basicTest() throws EnvironmentException, DebuggingException, InterruptedException {
	...
	@Test
	public void mouseTest() throws EnvironmentException, DebuggingException, InterruptedException {
		final SwingUnitTest	sut = new SwingUnitTest(root);
